...
$id=$_SESSION['id'];
$qur="SELECT * FROM `customer` WHERE `customer_id`=$id";
$res=$conn->query($qur);
$rec=mysqli_fetch_array($res);

$sql="SELECT * FROM `investment` WHERE `user_id`=$id AND`status`=1";
$allinv=$conn->query($sql);
                    ...
                    <div class="section">
                        ...
                        <div class="row vertical-modern-dashboard">
                            ...
                            <div class="col s12 m8 l8 animate fadeRight">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <h4 class="card-title mb-0">Total Invesment <i class="material-icons float-right">more_vert</i></h4>
                                        <?php
                                        $total=0; 
                                        for($i=0;$i<mysqli_num_rows($allinv);$i++){
                                            $temp=mysqli_fetch_array($allinv);
                                            $total=$total+$temp['ammount'];
                                        }
                                        ?>
                                        ₹ <?php echo $total;?>
                                        <br>
                                        <hr>
                                        <a href="invesments.php">View All Invesments</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="carousel carousel-slider center intro-carousel" style="height: 0px;">
                                            ...
                                            <div class="carousel-item slide-2" style="transform: translateX(0px) translateX(400px) translateZ(0px); z-index: -1; opacity: 1; visibility: visible;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col s6">
                                                        <div class="input-field">
                                                            <div class="select-wrapper"><input class="select-dropdown dropdown-trigger" type="text" readonly="true" data-target="select-options-2f403d67-6846-85f7-aef4-02cd780a302e"><ul id="select-options-2f403d67-6846-85f7-aef4-02cd780a302e" class="dropdown-content select-dropdown" tabindex="0"><li class="disabled selected" id="select-options-2f403d67-6846-85f7-aef4-02cd780a302e0" tabindex="0"><span>Choose your option</span></li><li id="select-options-2f403d67-6846-85f7-aef4-02cd780a302e1" tabindex="0"><span>Option 1</span></li><li id="select-options-2f403d67-6846-85f7-aef4-02cd780a302e2" tabindex="0"><span>Option 2</span></li><li id="select-options-2f403d67-6846-85f7-aef4-02cd780a302e3" tabindex="0"><span>Option 3</span></li></ul><svg class="caret" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"></path><path d="M0 0h24v24H0z" fill="none"></path></svg><select tabindex="-1">
