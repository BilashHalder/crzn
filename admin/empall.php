                            ...
                            <div class="col s12">
                                <div id="data-table-simple_wrapper" class="dataTables_wrapper">
                                    ...
                                    <table id="mytable" class="display dataTable dtr-inline responsive-table" role="grid" aria-describedby="data-table-simple_info" style="width: 1160px;">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" style="width: 189px;" aria-sort="ascending" aria-label="Id: activate to sort column descending">Employee Id</th>
                                        ...
                                        <tbody>
                                            ...
                                            echo "<h3>No Records Found</h3>";
                                                ...
                                                <td tabindex="0" class="sorting_1"><?php echo $rec['employee_id']?></td>
                                                <td><?php echo $rec['name']?></td>
                                                <td><?php echo $rec['phone']?></td>
                                                <td><?php echo $rec['email']?></td>
                                                <td><?php if($rec['status']==1) echo "Active"; else "Blocked";?></td>
                                                <td>
                                                    <a href="empinfo.php?id=<?php echo $rec['employee_id']?>">View </a>
                                                    </td>
                                            </tr>
