                                ...
                                <div class="col s12 m7">
                                    <div class="display-flex media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span>Associate Id : CRZNAST00<?php echo $data['associate_id']; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        ?>
                                            ...
                                            <div id="basic-form" class="card card card-default scrollspy">
                                                <div class="card-content">
                                                    ...
                                                    <form action="../services/db/associatekyc.php" method="get">
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <input type="number" name="id" hidden value="<?php echo $data['associate_id']; ?>">
                                                            <div class="row">
                                                                <div class="input-field col s12">
                            ...
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s6">
                                        ...
                                        <form action="../services/db/updateassimg.php" enctype="multipart/form-data"  method="POST">
                                    ...
                                    <div class="col s6">
                                        ...
                                        <form action="../services/db/updateasspass.php" enctype="multipart/form-data"  method="POST">
                                            <div class="row">
                                                <div class="input-field col s12">
