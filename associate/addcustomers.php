                        ...
                        <div class="card card card-default scrollspy ">
                            <div class="card-content">
                              ...
                              <h5 class="center">Add New Customer</h5>
                                <form class="formValidate" action="../services/associate/addcustomer.php" id="customerForm"  enctype="multipart/form-data"  method="POST" >
                                    <div class="row">
                                        ...
                                        <div class="input-field col s6 m4" hidden>
                                            <label for="ref_code">Referrel Code</label>
                                            <input id="ref_code" name="ref_code" type="text" data-error=".errorTxt4" value="<?php echo "CRZNAST00".$id;?>" >
