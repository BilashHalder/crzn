...
$id=$_SESSION['id'];
$qur="SELECT * FROM `offline_transaction` where customer_id=$id AND customer_type=2";
$res=$conn->query($qur);
            ...
            <div class="col s12 m12 l12">
                <div id="button-trigger" class="card card card-default scrollspy">
                    <div class="card-content">
                        <h4 class="card-title center">Offline Transactions Request </h4>
                        <div class="row">
                            <div class="col s12">
                            </div>
                            <div class="col s12">
                                    ...
                                    <table id="mytable" class="display dataTable dtr-inline responsive-table" role="grid" aria-describedby="data-table-simple_info" style="width: 1160px;">
                                        ...
                                        <tbody>
                                            ...
                                            echo "<h3>No Records Found</h3>";
                                                ...
                                                <td><?php if($rec['status']==0) echo "Pending"; else if($rec['status']==1) "Accepted"; else echo "Rejected";?></td>
                                                <td>
                                                    <a href="view.php?id=<?php echo $rec['file_url']?>">View </a>
                                                    </td>
                                            </tr>
