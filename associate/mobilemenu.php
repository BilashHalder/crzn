<li><a class="dropdown-menu" href="Javascript:void(0)" data-target="DashboardDropdownm"><i class="material-icons">dashboard</i><span><span class="dropdown-title" data-i18n="Dashboard">Dashboard</span><i class="material-icons right">keyboard_arrow_down</i></span></a>
                        ...
                        <li><a class="dropdown-menu" href="Javascript:void(0)" data-target="TemplatesDropdownm"><i class="material-icons">dvr</i><span><span class="dropdown-title" data-i18n="Templates">Customer</span><i class="material-icons right">keyboard_arrow_down</i></span></a>
                        ...
                        <li><a class="dropdown-menu" href="Javascript:void(0)" data-target="AppsDropdownm"><i class="material-icons">mail_outline</i><span><span class="dropdown-title" data-i18n="Apps">Invesments</span><i class="material-icons right">keyboard_arrow_down</i></span></a>
